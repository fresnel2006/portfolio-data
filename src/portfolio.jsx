...
// ─── Certifications : DATA & CLOUD en premier, DEV après ────────────────────
        ...
        <section id="about" className={styles.heroSection}>
            <div className={styles.heroContainer}>
                <div className={styles.heroInfo}>
                    ...
                    <h1 className={styles.heroTitle}>Data Engineer / Data Analyst</h1>
                    <p className={styles.heroDescription}>
                        Passionné par la donnée, je suis en formation en informatique et je construis
                        des pipelines qui collectent, nettoient et transforment des données brutes
                        en informations exploitables du requêtage SQL au traitement distribué
                        avec PySpark, jusqu'à la restitution via des tableaux de bord.<br /><br />
                        Je m'appuie sur des bases de données et services cloud (Firebase, Supabase,
                        PostgreSQL) pour structurer et exposer la donnée de façon fiable, et je
                        développe aussi des interfaces web et mobiles quand il faut connecter
                        ces données à des produits complets.<br /><br />
                        Curieux, rigoureux et méthodique, je continue d'apprendre chaque jour
                        pour maîtriser tout l'écosystème data de la collecte au traitement
                        jusqu'à l'analyse et livrer des solutions qui aident vraiment
